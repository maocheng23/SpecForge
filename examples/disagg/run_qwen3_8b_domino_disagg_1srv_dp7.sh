...
# IMPORTANT: for the LR schedule set this to the real step count of the whole
# run = ceil(NUM_EPOCHS * num_filtered_prompts / (TRAIN_DP * BATCH_SIZE)); a
...
WANDB_PROJECT=${WANDB_PROJECT:-qwen3-8b-domino-disagg}
...
wait $PRODUCER_PID
echo "QWEN3-8B-DOMINO-1SRV-DP7-DONE"
